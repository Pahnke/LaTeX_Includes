...
\newcommand{\nItem}[0]{\newpage \item}
% \begin{enumerate}[label = \arabic*)] % Numbers
% \begin{enumerate}[label = \alph*)]	% Letters
% \item
% \end{enumerate}
...
% \end{minted}
\usepackage{graphicx}
%\includegraphics[width=\textwidth]{Data1Plot.png}
...
\usepackage[%
    headheight=120pt, % height for the header block (no equivalent for footer)
]{geometry}
